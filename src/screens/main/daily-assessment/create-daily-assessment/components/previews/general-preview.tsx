        ...
        <>
          ...
          <View className='p-6 pt-5 gap-y-4'>
            <View className='flex-row'>
              <ValueItem label='Site location' value={generalInfo?.location.site_name} classNameWrap='flex-1' />
              <ValueItem label='Date' value={convertUTCDate(generalInfo?.date)} classNameWrap='flex-1' />
            </View>
            <ValueItem label='Project' value={generalInfo?.project} />
            <View className='flex-row'>
              <ValueItem label='Site Team Leader' value={generalInfo?.leader} classNameWrap='flex-1' />
              <ValueItem label='Principal Contractor' value={generalInfo?.contractor} classNameWrap='flex-1' />
            </View>
            <ValueItem label='Safe Work Method Statement' value={generalInfo?.methodStatement} />
            <ValueItem label='Description of Work' value={generalInfo?.description} />
          </View>
